...
$40,000, $30,000, $15,000, 11, $10,000, 9, 8, 7, \$5,000, 4, 3, 2, 1. (There is no 6 card.)

Money cards display a Dollar Sign (\$).
...
If any players have $15,000 or less in their hand at the time of the deal, the hand is declared a "misdeal" and the deal is done over.

### Bidding

Players bid for the privilege of choosing trump color. Bidding must begin at a minimum of $175,000, and typically ranges from $175,000 to $200,000, with the highest bid is usually from $210,000 to $250,000.

For example, following a starting bid of $175,000 (commonly expressed by saying "one seventy-five"), bids such as $190,000, $200,000, $210,000, $225,0000, $235,000 are proper.
...
After a player wins the bid, the widow is revealed for all players to see. The highest bidder then takes into his hand the widow of three cards. He may retain any or all of these in his hand, and then must discard three unwanted cards in their place. He must never discard the Bull, Bear, and Tiger. Although this is never an issue in standard play, the bidder also is prevented from discarding the color they will select as trump unless it is his only option: trump may be discarded only when the hand does not hold three other (non-Money, non-special) cards to fill the discard, and never more trump than is forced. When trump is discarded, the bidder must announce aloud the number of trump cards he discarded (the cards themselves stay face-down). Money is the last resort: a Money card may be discarded only when even the trump cards cannot fill the discard, and never more Money than is forced—in which case he must show the discarded Money cards to the other players. The highest bidder then announces the color of trump.
#### Example

![[Pasted image 20260604205032.png]]
...
The game is won by the side that first scores one million dollars. If both sides reach or exceed one million dollars at the end of the same hand, the team that won the bid on that hand wins the game.

### Optional rules
The game is played by default according to the above rules, but the following optional rule modifications can be made as desired:
- Misdeal: the amount required to trigger a misdeal can be modified as desired. The misdeal rule can also be removed entirely, or the redeal can be done only upon agreement of the other players instead of by default.
...
* Trump not led until played: with this rule, a player cannot lead out in Trump unless it has been played on a previous hand.
* Widow reveal: instead of being made public information, the widow can be kept private information, seen only by the high bidder.
* Set opening bid: players can be required to open bidding at $175,000, instead of being free to choose their opening bid as they wish.
* High score wins: the highest score (as opposed to the bid-taker) can be chosen to always win at the end of the game, even both teams pass 1 million.